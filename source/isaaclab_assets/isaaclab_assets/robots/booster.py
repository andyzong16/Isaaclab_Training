...
* :obj:`T1_29DOF_CFG`: T1 humanoid robot with 7DOF Arms
* :obj:`T1_23DOF_CFG`: T1 humanoid robot with 5DOF Arms
...
T1_29DOF_CFG = ArticulationCfg(
    ...
    actuators={
        ...
        "legs": DelayedPDActuatorCfg(
            ...
            min_delay=10, # physics time steps (max: 2.0*10=20.0ms)
            max_delay=20, # physics time steps (max: 2.0*20=40.0ms)
        ),
