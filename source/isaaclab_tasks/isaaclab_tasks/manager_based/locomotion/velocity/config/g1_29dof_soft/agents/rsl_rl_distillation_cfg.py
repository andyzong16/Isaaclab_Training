...
class G1FlatDistillationRunnerCfg(RslRlDistillationRunnerCfg):
    ...
    logger = "wandb"
    wandb_project = "g1_29dof_soft_flat_distillation"
    experiment_name = "g1_29dof_soft_flat_distillation"


@configclass
class G1FlatDistillationRunnerRecurrentCfg(G1FlatDistillationRunnerCfg):
