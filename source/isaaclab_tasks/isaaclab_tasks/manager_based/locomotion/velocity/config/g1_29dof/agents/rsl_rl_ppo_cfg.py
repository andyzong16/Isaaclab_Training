...
class G1RoughPPORunnerCfg(RslRlOnPolicyRunnerCfg):
    ...
    save_interval = 500
    obs_groups = {"actor": ["policy"], "critic": ["critic", "priviledged"]}
...
@configclass
class G1FlatPPORunnerWithSymmetryCfg(G1FlatPPORunnerCfg):
    ...
    algorithm = RslRlPpoAlgorithmCfg(
        ...
        desired_kl=0.01,
        max_grad_norm=1.0,
        symmetry_cfg=RslRlSymmetryCfg(use_data_augmentation=True, data_augmentation_func=g1.compute_symmetric_states),
    )


@configclass
class G1RoughPPORunnerWithSymmetryCfg(G1RoughPPORunnerCfg):
    """Configuration for the PPO agent with symmetry augmentation."""
