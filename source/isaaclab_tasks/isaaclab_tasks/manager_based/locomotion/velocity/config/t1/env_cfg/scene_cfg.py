...
# Pre-defined configs
##
from isaaclab_assets import T1_23DOF_CFG, T1_29DOF_MINIMAL_CFG  # type: ignore # isort: skip
...
class T1SceneCfg(InteractiveSceneCfg):
    ...
    # robots
    robot: ArticulationCfg = T1_29DOF_MINIMAL_CFG.replace(prim_path="{ENV_REGEX_NS}/Robot")
    # robot: ArticulationCfg = T1_23DOF_CFG.replace(prim_path="{ENV_REGEX_NS}/Robot")
    # sensors
