...
SoftTerrain = TerrainImporterCfg(
    ...
    # visual_material=sim_utils.PreviewSurfaceCfg(diffuse_color=(0.32, 0.24, 0.21), opacity=1.0),
)
    ...
    terrain_generator= terrain_gen.TerrainGeneratorCfg(
        ...
        sub_terrains={
            ...
            "wave": terrain_gen.HfWaveTerrainCfg(
                proportion=0.2, amplitude_range=(0.12, 0.12), num_waves=10, border_width=0.1,
            )
        },
    ),
    collision_group=-1,
