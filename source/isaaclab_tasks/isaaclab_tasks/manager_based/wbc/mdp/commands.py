...
class MotionCommand(CommandTerm):
    ...
    def __init__(self, cfg: MotionCommandCfg, env: ManagerBasedRLEnv):
        ...
        self.motion = MotionLoader(self.cfg.motion_file, self.body_indexes, device=self.device) # type: ignore
    ...
    def _resample_command(self, env_ids: Sequence[int]):
        ...
        joint_pos += sample_uniform(*self.cfg.joint_position_range, joint_pos.shape, joint_pos.device) # type: ignore
    ...
    def _update_command(self):
        ...
        self._resample_command(env_ids) # type: ignore
